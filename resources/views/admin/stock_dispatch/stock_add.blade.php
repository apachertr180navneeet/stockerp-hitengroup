    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Stock Dispatch Add</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Stock Dispatch Add</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2bs4 select2-hidden-accessible" name="from_id"
                                            ...
                                            @foreach ($branchlistfrom as $branchfrom)
                                                <option value="{{ $branchfrom->id }}">{{ $branchfrom->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-6 col-sm-offset-3 ml-2">
                                            ...
                                            <label class="radio-inline ml-2">
                                                <input type="radio" name="type" value="1" name="type"
                                                    onchange="showHideBranch()" id="branchredio" required /> Branch
                                            </label>
                                            <label class="radio-inline ml-2">
                                                <input type="radio" name="type" value="0" name="type"
                                                    onchange="showHideBranch()" checked="" id="customerredio"
                                                    required /> Customer
                                            </label>
                                        </div>
                                    </div>
