...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Credit Note Add</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Credit Note Add</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('admin.credit.note.store') }}" method="post" id="coustomer_add" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="credit_note_id">Credit Note</label>
                                    <input type="text" class="form-control" id="credit_note_id" name="credit_note_id" value="HTNCREDIT-{{ $creditnotenumber }}" readonly/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="credit_date" name="credit_date" value="{{ old('credit_date') }}" placeholder="Enter Date" />
                                    @error('credit_date')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-6 col-sm-offset-3 ml-2">
                                        ...
                                        <label class="radio-inline ml-2">
                                            <input type="radio" name="type" value="1" name="type" onchange="showHideBranch()" id="branchredio"/> Branch
                                        </label>
                                        <label class="radio-inline ml-2">
                                            <input type="radio" name="type" value="0" name="type" onchange="showHideBranch()" checked="" id="customerredio" /> Customer
                                        </label>
                                    </div>
                                </div>
    ...
    $(document).ready(function () {
        $('#addQuote').click(function () {
            ...
            $('#quoteTableBody').append(`<tr>
                                            <td>1</td>
                                            <td>`+productServiceName+`<input type="hidden" name="credit_item_id[]" value="`+productService+`"/></td>
