                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group" >
                                    ...
                                    <select class="form-control select2bs4 select2-hidden-accessible" name="branch_id" style="width: 100%;" aria-hidden="true" required>
                                        ...
                                        <option value="{{ $branch->id }}" {{$user_data->branch_id == $branch->id  ? 'selected' : ''}}>{{ $branch->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @else
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" minlength="10" maxlength="15" pattern="[0-9]{10,15}" name="phone_number" value="{{ old('phone_number') }}" placeholder="Enter Phone Number" required/>
                                    @error('phone_number')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
