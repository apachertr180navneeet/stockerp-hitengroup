            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('admin.user.update') }}" method="post" id="coustomer_add" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" minlength="10" maxlength="15" pattern="[0-9]{10,15}" name="phone_number" value="{{ $user->phone_number }}" placeholder="Enter Phone" required/>
                                    @error('phone_number')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
