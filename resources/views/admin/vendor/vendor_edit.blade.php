                        ...
                        <form role="form" action="{{ route('admin.vendor.update') }}" method="post" id="coustomer_add" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" maxlength="10" minlength="10" id="phone_number" name="phone_number" value="{{ $user->phone_number }}" placeholder="Enter Phone" required/>
                                    @error('phone_number')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
